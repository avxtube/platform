...
export default async function WorkerScraperSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {t("workerScraper.title")}
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              {t("workerScraper.description")}
            </p>
          </div>
        </div>
        <Link
      ...
      <RenderSettingGroup group="workerScraper" data={data} />
    </div>
  )
}
